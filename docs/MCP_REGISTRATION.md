...
Description:
Turns vague automation requests into MCP/plugin/skill stacks, copy-paste agent prompts, dry-run plans, QA/audit checks, recovery paths, and human boundaries.
