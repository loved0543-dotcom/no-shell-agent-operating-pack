...
### 가격 가설
- Free sample: "내 업무 자동화 10분 진단 카드" 1개.
- Starter: $19-$49, 한 업무용 운영팩.
- Pro bundle: $79-$199, 업무 5개 + 검증표 + 복구 플레이북.
- Custom audit: $300-$500, 고객 업무 1개를 실제 자동화 설계서로 바꿔주는 건별 리포트.
...
- Gumroad/Lemon Squeezy/Ko-fi 같은 디지털 파일 판매 표면.
...
### 첫 실험
20명에게 무료 진단 카드를 보여주고, 3명 이상이 Starter를 사거나 자기 업무 버전을 요청하면 유지한다.

## 6. Price Ladder
1. Free: 자동화 실패 진단 카드.
2. Starter $29: 한 업무 운영팩.
3. Bundle $99: 이메일/문서/SNS/리서치/보고서 5팩.
4. Custom $300: 업무 1개 심화 설계 리포트.
