...
## Upload candidate
- Customer upload candidate: `dist/no-shell-agent-operating-pack-starter-v1.zip`
- Internal workbench archive: `dist/no-shell-agent-operating-pack-workbench-v1.zip`
