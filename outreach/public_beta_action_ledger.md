...
2026-06-15T14:23:00Z,retry_after_extension_enabled,extension_enabled_native_host_blocker,Hacker News Show HN,Codex Chrome Extension is enabled now; Chrome control still unavailable because native host registry is missing and Computer Use native pipe is unavailable,no,Repair/reinstall Chrome plugin native host from Codex plugin UI or submit from opened Chrome tab
2026-06-15T14:32:00Z,attempt_official_chrome_plugin_repair,official_plugin_cli_retry,Hacker News Show HN,Codex Desktop opened; codex plugin add/remove chrome@openai-bundled failed with OS access denied; bundled marketplace cannot be upgraded because it is not a Git marketplace,no,Close/restart Codex processes and repair Chrome plugin native host from Codex plugin UI or submit from opened Chrome tab
```
