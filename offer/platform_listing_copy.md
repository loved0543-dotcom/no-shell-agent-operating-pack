...
## 상품명
No-Shell Agent Operating Pack: Email & Document Automation Starter

## 짧은 설명
AI에게 "자동화해줘"라고 말하면 껍데기만 나오는 사람을 위한 자연어 운영팩입니다. 이메일/문서 업무를 목표, 입력, 출력, 도구, 사람 확인 경계, 테스트, 실패복구까지 갖춘 실제 자동화 흐름으로 좁혀줍니다.

## 긴 설명
ChatGPT, Claude, Codex, Gemini를 이미 써봤지만 자동화 결과가 실제 업무로 이어지지 않았다면, 문제는 도구가 아니라 업무를 맡기는 구조일 가능성이 큽니다.

이 팩은 코딩 강의가 아닙니다. 비전공자가 자기 업무를 AI에게 설명하고, 어떤 도구가 필요한지 고르고, 결과물이 빈껍데기인지 검증하고, 실패했을 때 원인을 고치는 운영표입니다.

## 포함 파일
- AI 자동화 실패 무료 진단 카드
- 이메일/문서 자동화 Starter Pack
- Before/After 데모
- 도구 라우터
- 복붙 명령어 카드
- No-Shell 결과 검증표
...
- Lemon Squeezy products: https://docs.lemonsqueezy.com/help/products/adding-products
