...
MUST_CONTAIN = {
    ...
    "outreach/public_beta_tracker.md": ["Public Beta Signal Tracker", "GitHub stars", "Paid Version Boundary"],
    "landing/index.html": ["Download ZIP", "무료 공개 베타", "Before / After"],
    "README.md": ["Customer ZIP", "Public beta tracker", "No payment connection"],
