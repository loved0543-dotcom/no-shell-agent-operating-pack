...
MUST_CONTAIN = {
    ...
    "outreach/public_beta_tracker.md": ["Public Beta Signal Tracker", "GitHub stars", "Release asset downloads", "GitHub Download Visibility Boundary", "Paid Version Boundary", "Latest Automated Snapshot"],
