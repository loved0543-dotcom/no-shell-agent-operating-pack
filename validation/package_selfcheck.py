...
MUST_CONTAIN = {
    ...
    "offer/pricing_and_gtm.md": ["$29", "$99", "$300", "Kill condition"],
    ...
    "offer/platform_listing_copy.md": ["Gumroad", "Lemon Squeezy", "Ko-fi", "$29"],
    "outreach/20_person_test_list.md": ["20명", "성공 기준", "실패 기준"],
    "outreach/validation_tracker.md": ["PASS", "WARN", "FAIL", "price_reaction"],
    "landing/index.html": ["Download ZIP", "가격 가설", "Before / After"],
    "README.md": ["Customer ZIP", "20-person validation", "No payment connection"],
